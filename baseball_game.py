...
def is_digit(user_input_number):
    ...
    f_user_input_number = user_input_number
    for i in f_user_input_number :
        if i < '0' or i > '9' :
            return False
    # ==================================
    return True
...
def is_duplicated_number(three_digit):
    ...
    if (three_digit[0] == three_digit[1] or
        three_digit[0] == three_digit[2] or
...
def is_yes(one_more_input):
    ...
    # ===Modify codes below=============
    # 조건에 따라 변환되어야 할 결과를 result 변수에 할당
    f_one_more_input = one_more_input.lower()
    if(f_one_more_input == 'y' or f_one_more_input == 'yes') :
        return True
    # ==================================
    return False
...
def is_no(one_more_input):
    ...
    # 조건에 따라 변환되어야 할 결과를 result 변수에 할당
    f_one_more_input = one_more_input.lower()
    if f_one_more_input == 'n' or f_one_more_input == 'no' :
        return True
    # ==================================
    return False
...
def main():
    ...
    while(playing):
        ...
        while(True):
            play_str = input("You win, one more(Y/N)?")
            if play_str == '0' :
                playing = False
                break
            elif is_yes(play_str) :
                break
            elif is_no(play_str) :
                playing = False
                break
